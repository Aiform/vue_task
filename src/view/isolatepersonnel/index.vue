		...
		<el-card>
			<div class="header">
				<el-form  label-width="120px" style="display: flex; flex-wrap: wrap;">
					<el-button  style="background: #10aeb5;"  @click="newisolationpersonnel"><el-icon style="margin-right: 5px;"><EditPen/></el-icon>新增隔离人员信息</el-button>
		...
		setup(){
			...
			const search = ()=>{
				if(keyword.value  == ''){
					...
					setTimeout(() => {
						loading.close()
						store.dispatch('Allpersonnel',{num:num.value,keyword:keyword.value})
