		...
		<el-card>
			...
			<el-form   style="margin-top: 30px;">
				...
				<el-form-item label="年龄:">
					<el-input v-model.number.trim="form.age" placeholder="请输入你的年龄"/>
				</el-form-item>
				<el-form-item label="联系方式:">
					<el-input v-model.number.trim="form.contact" placeholder="请输入你的联系方式"/>
				</el-form-item>
				<el-form-item label="身份证号码:">
					<el-input v-model.trim="form.idnumber" placeholder="请输入你的身份证号码"/>
				</el-form-item>
				<el-form-item label="家庭住址:">
					<el-input v-model.trim="form.address" placeholder="请输入你的家庭住址" />
				</el-form-item>
				<el-form-item label="隔离地点:">
					<el-input v-model.trim="form.Isolationaddress" placeholder="请输入你的隔离地点"/>
				</el-form-item>
				...
				<el-form-item label="体温:">
					<el-input v-model.trim="form.temperature" placeholder="请输入你的体温" />
				</el-form-item>
			</el-form>
			<div class="but">
