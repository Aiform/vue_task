<template>
	<el-card class="box-card boxCard">
		<div class="header">
			<span>本月全国疫情确诊数量</span>
			<el-tooltip class="box-item" effect="dark" content="指标说明"  placement="top">
				<el-icon :size="20" class="item"><WarningFilled /></el-icon>
			</el-tooltip>
		</div>
		<div class="total">205,354</div>
		<div class="trends">
			<span>周同比12%<el-icon :size="13" style="color: red;"><CaretTop/></el-icon>	</span>
			<span style="margin-left: 20px;">日同比10%<el-icon :size="13" style="color: green;"><CaretBottom/></el-icon>	</span>
		</div>
		<div class="hr"></div>
		<div class="footer">
