<template>
	<div class="distributionofepidemicareas">
		<el-card>
			<div class="header">
				<el-icon style="color:#10aeb5;font-size: 20px;"><LocationInformation /></el-icon><h4>全国低中高风险地区分布</h4>
			</div>
			<el-divider />
...
<script type="text/javascript">
	...
	export default {
		setup(){
			...
			const map = ()=>{
				var chartDom = document.querySelector('.map');
